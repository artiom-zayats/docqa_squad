...
class Question(object):
    ...
    def __init__(self, question_id: str, words: List[str], answer: int, choices: List[List[str]]):
...
class Paragraph(object):
    ...
    def __init__(self,
                 ...
                 mult_anwsers : Optional[np.ndarray] = None):
        self.text = context
        self.mult_anwsers = mult_anwsers
...
class DocParagraphAndQuestion(ContextAndQuestion):
    ...
    def __init__(self, question: List[str], answer: Optional[Answer],
                 question_id: str, paragraph: Paragraph, choices: List[List[str]]):
    ...
    for doc in docs:
        for i, para in enumerate(doc.paragraphs):
            for question in para.questions:
                paras.append(DocParagraphAndQuestion(question.words, question.answer, question.question_id, para, question.choices))
    return paras
                ...
                for doc in fn():
                    for para in doc.paragraphs:
                        ...
                        for question in para.questions:
                            ...
                            #no words in anwser
                            #az
                            voc.update(x.lower() for choice in question.choices for x in choice)
